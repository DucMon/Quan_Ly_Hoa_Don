...
alter PROC USP_GetHDbyID
 AS
 BEGIN
	SELECT SoHDBan AS 'Số Hóa Đơn',KyHieu AS 'Ký Hiệu',MDVMH AS 'Mã KH',TenDonViMuaHang AS ' Tên Đơn Vi Mua Hàng', NguoiMuaHang AS 'Người Mua Hàng', MaSoThueMua AS 'Mã Số Thuế',DiaChiMua AS 'Địa Chỉ', STKMua AS 'Số TK',NgayHD AS 'NgàyXuất',HinhThucThanhToan AS 'Hình Thức', TongTien AS 'Tổng Tiền' FROM dbo.HoaDonBan
